...
export default function MessageAction({
  ...
  return (
    <div class="flex absolute items-center justify-between <sm:bottom--11 <sm:right-4  z-10 right-2 text-sm text-slate-7 dark:text-slate group-hover:opacity-100 group-focus:opacity-100 opacity-0 dark:bg-#292B32 bg-#E7EBF0 rounded">
